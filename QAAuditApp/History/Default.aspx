    ...
    <div class="row">
        <div class="col-6">
            ...
            <table class="table table-borderless table-striped table-earning">
                <tr>
                <td width="50%">
                    <asp:DropDownList CssClass="form-control-lg form-control" ID="ddl_history" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddl_history_SelectedIndexChanged"></asp:DropDownList>
                </td>
                </tr>
            </table>
        </div>
