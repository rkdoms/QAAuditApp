...
namespace QAAuditApp
{
    public partial class Details : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {            
                ...
                else
                {
                    ...
                    startTimeActive.Value = activeArchive.StartTime.ToString();
                    endTimeActive.Value = activeArchive.EndTime.ToString();
        ...
        protected void CreateGridAndHeaderInfo(bool headerInfo = false)
        {
            ...
            grid1.Visible = true;
            grid1.DataSource = audit.AuditDetail;
            grid1.DataBind();
        }
        ...
        protected void grid1_UpdateCommand(object sender, Obout.Grid.GridRecordEventArgs e)
        {
            try
            {
                AuditDetail det = new AuditDetail();
                det.SourceInfoId = Int32.Parse(e.Record["SourceInfoId"].ToString());
